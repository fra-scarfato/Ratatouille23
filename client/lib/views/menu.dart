      ...
      builder: (BuildContext context, snapshot) {
        ...
        if (snapshot.connectionState == ConnectionState.done) {
          ...
          widget = Scaffold(
            ...
            floatingActionButton: bottone_gestione_menu_admin(listaCategorie: menu, utente: utente),
    ...
    List<Widget> list = [];
        if (categoria.get_elementi()!.isNotEmpty) {
          categoria.get_elementi()!.forEach((element) {
            list.add(elementi_card(utente: widget.utente, elemento: element, listaCategorie: listaCategorie,));
          });
        }
